...
export const TIER_MODEL: Record<ModelTier, ChatModel> = {
  ...
  balanced: { provider: PROVIDER, model: "gpt-5.1" }, // strong general/code, mid cost
  fast: { provider: PROVIDER, model: "gemini-2.5-flash" }, // cheap, fast, multilingual, 1M ctx
  cheap: { provider: PROVIDER, model: "gemini-2.5-flash-lite" }, // cheapest, trivial tasks
};
